...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference("Tour.count") do
      post tours_url, params: { tour: { activity: @tour.activity, date: @tour.date, days: @tour.days, destination: @tour.destination, price: @tour.price } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { activity: @tour.activity, date: @tour.date, days: @tour.days, destination: @tour.destination, price: @tour.price } }
